...
class Canvas:
    def __init__(self, label, figure_color, clipper_color, background_color):    # colour, line_colour,
        self.label = label
        ...
        self.figure = Figure(figure_color)
    ...
    def add_point_figure(self, p: Point):
        self.figure.add_point(p)

    def change_figure_color(self, color: QColor):
        self.figure.color = color

    def draw_figure(self, import_img=True):
        self.figure.draw(self.qp)
        if import_img:
            self.import_img()
    ...
    def clear_canvas(self):
        ...
        self.figure = Figure(self.figure.color)
