...
class Canvas:
    ...
    def new_clipper(self, p1: Point, p2: Point, color: QColor):
        self.clipper = Clipper(p1, p2, color)
    ...
    # def draw_clipper_by_clipper(self, clipper: Clipper):
    #     clipper.draw(self.qp)
    #     self.import_img()
