...
def get_cross_point(begin1: Point, end1: Point, begin2: Point, end2: Point):
    ...
    coef = [[end1.x - begin1.x, begin2.x - end2.x], [end1.y - begin1.y, begin2.y - end2.y]]
    rights = [[begin2.x - begin1.x], [begin2.y - begin1.y]]
...
def cut_sutherland_hodgman(figure: Figure, clipper: Clipper):
    ...
    A_figure = figure.points
    res_B_figure = []
    C_clipper = clipper.points
    ...
    for i in range(len_C_clipper - 1):  # цикл по всем границам отсекателя
        ...
        for j in range(len_A_figure):  # цикл по всем границам отсекаемого многоугольника
            if j == 0:
                ...
                # print(f'is_crossing: {s}-{A_figure[j]}, {C_clipper[i]}-{C_clipper[i + 1]}: ', end=' ')
                # print(is_crossing)
        ...
        if len_res_B_figure != 0:
            ...
            if is_crossing:
                ...
                len_res_B_figure += 1
        A_figure = res_B_figure[:]
        len_A_figure = len_res_B_figure
        # print(A_figure)
